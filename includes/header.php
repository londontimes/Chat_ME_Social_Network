...
<nav class="navbar navbar-default">
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="homepage.php">Chat Me</a>
		</div>
				...
				<li class="dropdown">
					<form class="navbar-form navbar-left" method="get" action="results.php">
						<div class="form-group">
							<input type="text" class="form-control" name="user_query" placeholder="Search Posts">
						</div>
						<button type="submit" class="btn btn-info" title="Click to search posts by keyword" name="search">Search</button>
					</form>
				</li>
			</ul>
		</div>
